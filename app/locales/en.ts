...
const en: LocaleType = {
  ...
  Error: {
    Unauthorized: isApp
      ? `Oops, there's an issue. No worries:\n-Want to use your own OpenAI resources? [Settings](/#/settings) to change settings`
      : `Oops, there's an issue. Let's fix it:\n-Using a private setup? [Auth](/#/auth) to enter your key\n-Want to use your own OpenAI resources? [Setting](/#/settings) to change settings`,
  },
  Auth: {
    Return: "Return",
